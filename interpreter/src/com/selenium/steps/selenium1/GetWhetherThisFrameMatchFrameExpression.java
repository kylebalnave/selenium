 ...
 * @author kyleb2
 */
public class GetWhetherThisFrameMatchFrameExpression extends Step implements IStep {

    public GetWhetherThisFrameMatchFrameExpression(WebDriver wd, Object... args) throws StepException {
        super(wd, args);
    }
