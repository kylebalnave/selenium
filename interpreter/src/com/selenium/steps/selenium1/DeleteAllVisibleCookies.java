 ...
 * @author kyleb2
 */
public class DeleteAllVisibleCookies extends Selenium1Step implements IStep {

    public DeleteAllVisibleCookies(WebDriver wd, String param1, String param2) throws StepException {
