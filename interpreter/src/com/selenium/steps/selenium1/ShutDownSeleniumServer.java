 ...
 * @author kyleb2
 */
public class ShutDownSeleniumServer extends Selenium1Step implements IStep {

    public ShutDownSeleniumServer(WebDriver wd, String param1, String param2) throws StepException {
