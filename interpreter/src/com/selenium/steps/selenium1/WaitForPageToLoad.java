 ...
 * @author kyleb2
 */
public class WaitForPageToLoad extends Selenium1Step implements IStep {

    public WaitForPageToLoad(WebDriver wd, String param1, String param2) throws StepException {
