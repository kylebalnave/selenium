 ...
 * @author kyleb2
 */
public class ClickAt extends Selenium1Step implements IStep {

    public ClickAt(WebDriver wd, String param1, String param2) throws StepException {
    ...
    public Object run() {
        ...
        action.moveToElement(wd.findElement(Selectors.select(param1))).
               moveByOffset(offsetX, offsetY).click();
        return null;
    }

    @Override
    public String getDescription() {
        return String.format("Click %s with offset", param1, param2);
    }
