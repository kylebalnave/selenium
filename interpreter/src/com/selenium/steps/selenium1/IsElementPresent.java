 ...
 * @author kyleb2
 */
public class IsElementPresent extends Selenium1Step implements IStep {

    public IsElementPresent(WebDriver wd, String param1, String param2) throws StepException {
