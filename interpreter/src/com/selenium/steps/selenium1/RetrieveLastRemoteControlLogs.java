 ...
 * @author kyleb2
 */
public class RetrieveLastRemoteControlLogs extends Step implements IStep {

    public RetrieveLastRemoteControlLogs(WebDriver wd, Object... args) throws StepException {
        super(wd, args);
    }
