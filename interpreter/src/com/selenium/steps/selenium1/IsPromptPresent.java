 ...
 * @author kyleb2
 */
public class IsPromptPresent extends Selenium1Step implements IStep {

    public IsPromptPresent(WebDriver wd, String param1, String param2) throws StepException {
