 ...
 * @author kyleb2
 */
public class GetAllWindowIds extends Selenium1Step implements IStep {

    public GetAllWindowIds(WebDriver wd, String param1, String param2) throws StepException {
