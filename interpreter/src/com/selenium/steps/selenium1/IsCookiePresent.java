 ...
 * @author kyleb2
 */
public class IsCookiePresent extends Selenium1Step implements IStep {

    public IsCookiePresent(WebDriver wd, String param1, String param2) throws StepException {
