 ...
 * @author kyleb2
 */
public class GetWhetherThisWindowMatchWindowExpression extends Step implements IStep {

    public GetWhetherThisWindowMatchWindowExpression(WebDriver wd, Object... args) throws StepException {
        super(wd, args);
    }
