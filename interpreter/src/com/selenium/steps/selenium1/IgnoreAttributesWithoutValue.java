 ...
 * @author kyleb2
 */
public class IgnoreAttributesWithoutValue extends Step implements IStep {

    public IgnoreAttributesWithoutValue(WebDriver wd, Object... args) throws StepException {
        super(wd, args);
    }
