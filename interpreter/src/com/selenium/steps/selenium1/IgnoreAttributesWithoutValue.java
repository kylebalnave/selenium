 ...
 * @author kyleb2
 */
public class IgnoreAttributesWithoutValue extends Selenium1Step implements IStep {

    public IgnoreAttributesWithoutValue(WebDriver wd, String param1, String param2) throws StepException {
