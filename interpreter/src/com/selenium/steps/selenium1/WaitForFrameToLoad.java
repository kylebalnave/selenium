 ...
 * @author kyleb2
 */
public class WaitForFrameToLoad extends Selenium1Step implements IStep {

    public WaitForFrameToLoad(WebDriver wd, String param1, String param2) throws StepException {
