 ...
 * @author kyleb2
 */
public class GetAllWindowTitles extends Selenium1Step implements IStep {

    public GetAllWindowTitles(WebDriver wd, String param1, String param2) throws StepException {
