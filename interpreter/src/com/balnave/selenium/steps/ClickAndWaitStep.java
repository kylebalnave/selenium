...
import com.balnave.selenium.steps.helpers.Selectors;
...
public class ClickAndWaitStep extends SelectionStep implements IStep {
    ...
    public String toJavaString() {
        return String.format("%s\n%s\n%s\n",
                ...
                String.format("wait.until(org.openqa.selenium.support.ui.ExpectedConditions.elementToBeClickable(com.balnave.selenium.steps.helpers.Selectors.select(\"%s\")));", (String) getArg(1)),
